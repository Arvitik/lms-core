...
@section('content')
    <div class="section-body tests-page">
        <div class="col-md-12 col-sm-12 card style-gray text-center tests-page-header">
            <h2 class="text-default-bright">Контрольные тесты</h2>
        </div>
        <div class="col-lg-offset-1 col-md-10 col-sm-10">
            <div class="card style-default-light tests-page-list">
                        ...
                        @foreach ($ctr_tests as $test)
                            @if ($test['access_for_student'] == 1)
                                <a href="{{ route('question_showtest', $test['id_test']) }}">
                                    <div class="col-md-12 col-sm-12 card test-list text-lg dropdown test-card test-card-available">
                            ...
                            @else
                                <a>
                                    <div class="col-md-12 col-sm-12 card test-list text-lg dropdown test-card test-card-locked">
                                        <button class="dropbtn">{{ $test['test_name'] }}</button>
                                        <div class="dropdown-content">
