...
<div class="container-fluid px-5">
    ...
    <div class="alert alert-info mt-3">
        <strong>Информация:</strong> В верхней строке таблицы отображается средний процент посещаемости группы ТОЛЬКО на тех лекциях, для которых установлен лимит. Формула: (лимит на лекции) / (всего студентов в группе) × 100%
    </div>
