...
@section('content')
    <div class="col-lg-offset-1 col-md-offset-1 col-sm-offset-1 col-md-10 col-sm-10 card style-default-light page-main-card">
        ...
        @if(Auth::user()['role'] == 'Староста')
            <div class="text-center" style="margin-top: 30px;">
                <a href="{{ route('steward.attendance') }}" class="btn btn-primary btn-raised">
                    Отметить студентов на лекции
                </a>
            </div>
        @endif
        @if(count($news) != 0)
                ...
                <div class="card card-bordered style-warning">
                    ...
                    <div class="card-body style-default-bright">
                        ...
                        @if($post['file_path'] != null)
                            {!! HTML::link($post['file_path'], 'Скачать файл', ['class' => 'btn btn-primary btn-raised submit-question', 'role' => 'button']) !!}
                        @endif
                    </div>
                </div>
            @endif
