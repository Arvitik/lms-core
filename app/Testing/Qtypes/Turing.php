...
class Turing extends QuestionType implements Checkable {
    ...
    public function show($count) {
        ...
        $array = array('view' => $view, 'arguments' =>
            array(
                ...
                // Ð§Ð¸ÑÐ»Ð¾ Ð½Ð°Ð¶Ð°Ñ‚Ð¸Ð¹ Ð½Ð° ÐºÐ½Ð¾Ð¿ÐºÑƒ "ÐŸÑ€Ð¾Ð²ÐµÑ€Ð¸Ñ‚ÑŒ Ñ€Ð°Ð±Ð¾Ñ‚Ñƒ"
                "debug_counter" => 0,
                // Ð§Ð¸ÑÐ»Ð¾ Ð½Ð°Ð¶Ð°Ñ‚Ð¸Ð¹ Ð½Ð° ÐºÐ½Ð¾Ð¿ÐºÑƒ "ÐŸÑ€Ð¾Ð²ÐµÑ€Ð¸Ñ‚ÑŒ ÑÐ¸Ð½Ñ‚Ð°ÐºÑÐ¸Ñ"
                'check_syntax_counter' => 0,
                // Ð§Ð¸ÑÐ»Ð¾ Ð½Ð°Ð¶Ð°Ñ‚Ð¸Ð¹ Ð½Ð° ÐºÐ½Ð¾Ð¿ÐºÑƒ "Ð—Ð°Ð¿ÑƒÑÑ‚Ð¸Ñ‚ÑŒ"
                'run_counter' => 0,
                "type" => self::type_code,
                "id" => $this->id_question,
                "count" => $count));
    ...
    public function check($array) {
        ...
        $mark = $sequences_true == $sequences_all ? 'Ð’ÐµÑ€Ð½Ð¾' : 'ÐÐµÐ²ÐµÑ€Ð½Ð¾';
    ...
    public function pdf(Mypdf $fpdf, $count, $answered=false, $paper_savings=false) {
        ...
        $html .= '  ÐÐ°Ð¿Ð¸ÑˆÐ¸Ñ‚Ðµ Ñ€ÐµÑˆÐµÐ½Ð¸Ðµ Ð·Ð°Ð´Ð°Ñ‡Ð¸ Ð½Ð° ÐœÐ°ÑˆÐ¸Ð½Ðµ Ð¢ÑŒÑŽÑ€Ð¸Ð½Ð³Ð°</td></tr>';
        ...
        if ($answered == false) {
            $html .= '<p>Ð’Ð°Ñˆ Ð°Ð»Ð³Ð¾Ñ€Ð¸Ñ‚Ð¼:</p>';
